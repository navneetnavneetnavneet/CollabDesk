...
const DesktopSidebar = () => {
  return (
    <aside className="relative w-60 h-full hidden sm:flex flex-col border-r border-zinc-800">
      ...
      <div className="w-full px-2 py-2 hover:bg-zinc-800 duration-300 border-b border-zinc-800 flex items-center gap-2">
      ...
      <button className="absolute bottom-2 left-2  px-4 py-2 rounded-md bg-red-500 hover:bg-red-600 duration-300 text-white font-medium tracking-tight cursor-pointer">
        Logout
      </button>
    </aside>
  );
